...
import { FiCheckCircle, FiUser, FiArrowRight, FiLifeBuoy } from 'react-icons/fi';
...
export default function TrainerDashboardPage() {
  ...
  useEffect(() => {
    if (user && user.role !== 'TRAINER') router.push('/unauthorized');
  }, [user, router]);
  ...
  const cards = [
    {
      ...
      desc: 'Create and manage training assessments',
    },
    {
      href: '/profile',
  ...
  return (
    <DashboardLayout title="Trainer Dashboard">
      ...
      <div
        ...
        style={{ background: 'linear-gradient(135deg, #34C759 0%, #5AC8FA 100%)' }}
      >
        ...
        <div className="relative z-10 px-6 py-7">
          <p className="text-white/70 text-[13px] font-medium mb-1">Trainer Portal</p>
          ...
          <p className="text-white/75 text-[13px] leading-relaxed max-w-sm">
            Build assessments, track student progress, and manage your training modules.
          </p>
        </div>
      </div>
