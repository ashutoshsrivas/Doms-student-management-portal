...
function EditAnnouncementContent() {
  ...
  useEffect(() => {
    ...
    if (!user || !token || !announcementId) return;
      ...
      try {
        ...
        if (data.success && data.data) {
          ...
          if (announcement.fileUrl) {
            ...
            setFilePreview(announcement.fileUrl);
          }
        } else {
                ...
                <div className="border border-gray-300 rounded-lg p-4">
                  {filePreview && file?.type.startsWith('image/') ? (
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg mb-4">
                      <div>
                        <p className="font-medium text-gray-900">{file?.name || existingFileName}</p>
                  ...
                  <button
                    type="button"
                    onClick={() => fileInputRef.current?.click()}
                    className="mt-3 px-4 py-2 text-sm bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg font-medium transition"
                  >
                    Change File
                  </button>
                  <input
